...
keras.utils.plot_model(model, to_file='model_or_complete.png', show_shapes=True, show_layer_names=True,
...
plt.tight_layout()
plt.savefig("predictions_linear_or_1000.svg")
...
plt.legend()
plt.tight_layout()
plt.savefig("train_acc_loss_or.svg")
