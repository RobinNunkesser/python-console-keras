...
def transformi(i):
    return huber_loss(ops.expand_dims(i[0], 0), ops.expand_dims(i[1], 0))#np.array([i[0]+2,i[1]+3])
...
plt.xlabel("Gewichtete Zukunftsbelohnung")
plt.ylabel("Vorhersage Critic")
plt.colorbar()

plt.tight_layout()
plt.savefig("huber_loss.svg")
